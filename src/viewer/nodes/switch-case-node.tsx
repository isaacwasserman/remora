...
export function SwitchCaseNode({ data, selected }: NodeProps) {
	...
	if (isGroup) {
		...
		return (
			<div
				className={`rounded-xl border-2 border-dashed transition-colors duration-150 border-amber-300 bg-amber-50/30 hover:bg-amber-50/60 hover:border-amber-500 dark:border-amber-700 dark:bg-amber-950/30 dark:hover:bg-amber-950/50 dark:hover:border-amber-500 ${ringClass}`}
