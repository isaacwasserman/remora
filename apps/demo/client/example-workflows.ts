    ...
    outputSchema: {
        ...
        properties: {
            team: {
                type: "array",
                description:
                    "Detailed stats for each Pokémon of the chosen type",
            },
            matchups: {
                type: "object",
...
export const POKEMON_ANALYST: WorkflowDefinition = {
    ...
    outputSchema: {
        ...
        properties: {
            pokemon: {
                type: "string",
                description: "Name of the analyzed Pokémon",
            },
            rating: {
                type: "number",
            ...
            strategy: {
                type: "object",
                description:
                    "Final battle strategy and teammate recommendations",
            },
        },
    },
    steps: [
        ...
        },
        {
            ...
            name: "LLM Analysis",
            description:
                "Use an LLM to analyze the Pokémon's competitive viability",
            type: "llm-prompt",
                ...
                outputFormat: {
                    ...
                    properties: {
                        ...
                        role: {
                            type: "string",
                            description:
                                "Ideal battle role (e.g. sweeper, wall, support)",
                        },
                    },
                ...
                outputFormat: {
                    ...
                    properties: {
                        ...
                        tier: {
                            type: "string",
                            description:
                                "Competitive tier (e.g. OU, UU, RU, NU, Ubers)",
                        },
                    },
