...
export function randomizeTheme(dark: boolean) {
    ...
    if (dark) {
        ...
        setVar(
            "--popover-foreground",
            oklch(rand(0.92, 0.98), tint * 0.4, hue),
        );
        ...
        setVar(
            ...
            oklch(rand(0.92, 0.98), tint * 0.5, hue),
        );
        ...
        setVar(
            ...
            oklch(0.64, rand(0.2, 0.25), destHue),
        );
        ...
        setVar(
            "--sidebar-primary",
            oklch(rand(0.45, 0.55), rand(0.2, 0.27), hue),
        );
        setVar(
        ...
        setVar(
            "--destructive-foreground",
            oklch(0.58, rand(0.2, 0.26), destHue),
        );
        ...
        setVar(
            "--sidebar-primary",
            oklch(rand(0.35, 0.5), rand(0.18, 0.27), hue),
        );
        setVar("--sidebar-primary-foreground", oklch(0.985, tint, hue));
        setVar("--sidebar-accent", oklch(secL, tint * 2, hue));
        setVar(
            "--sidebar-accent-foreground",
            oklch(rand(0.15, 0.25), tint, hue),
        );
