...
export interface SimpleExpressionNode<
    T extends SimpleExpressionType = SimpleExpressionType,
> {
    readonly type: T;
}
export interface UnaryExpressionNode<
    T extends UnaryExpressionType = UnaryExpressionType,
> {
    readonly type: T;
...
export interface BinaryExpressionNode<
    T extends BinaryExpressionType = BinaryExpressionType,
> {
    readonly type: T;
    readonly left: ExpressionNode;
    readonly right: ExpressionNode;
