...
import type { LexerOptions, LexerToken } from "./Lexer.type";
import Parser from "./Parser";
import type { Options } from "./Parser.type";
import {
    type BuiltInFunctionNames,
    InputArgument,
    type InputSignature,
...
const registerFunction = (
    ...
    TreeInterpreterInst.runtime.registerFunction(
        functionName,
        customFunction,
        signature,
        options,
...
const register = <T extends string>(
    ...
    return TreeInterpreterInst.runtime.register(
        name,
        customFunction,
        signature,
        options,
...
const unregisterFunction = <T extends string>(
    name: T extends BuiltInFunctionNames ? never : T,
): boolean => {
