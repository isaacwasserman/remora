...
import { inferQueryOutputSchema } from "./type-inference";
...
describe("inferQueryOutputType", () => {
    ...
    describe("diagnostics", () => {
        ...
        test("union access reports the union and each bad branch", () => {
            const schema: JSONSchema7Definition = {
                type: "object",
                properties: {
                    a: {
