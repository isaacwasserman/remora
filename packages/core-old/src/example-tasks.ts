        ...
        workflow: {
            ...
            steps: [
                ...
                },
                {
                    ...
                    description:
                        "Use LLM to extract moderation decision from submission",
                    type: "extract-data",
                    params: {
                        sourceData: {
                            type: "jmespath",
                ...
                },
                {
                    ...
                    params: {
                        ...
                        toolInput: {
                            ...
                            message: {
                                type: "literal",
                                value: "Your submission has been removed for policy violations.",
                            },
                        },
                    },
                },
                {
                    ...
                    description:
                        "Quarantine borderline content for manual review",
                    type: "tool-call",
                    params: {
                        toolName: "quarantine-content",
                        toolInput: {
                ...
                },
                {
                    ...
                    type: "llm-prompt",
                    params: {
                        prompt: "Generate a moderation summary for ${length(moderate_all)} processed submissions.",
                        outputFormat: {
                            type: "object",
                            properties: {
        ...
        workflow: {
            ...
            steps: [
                ...
                },
                {
                    ...
                    type: "llm-prompt",
                    params: {
                        prompt: "Select appropriate courses for student ${student.name} (grade: ${student.grade}). Available courses: ${get_courses.courses}. Return the IDs of selected courses.",
                        outputFormat: {
                            type: "object",
                            properties: {
                                selectedCourseIds: {
                ...
                },
                {
                    ...
                    description:
                        "Iterate over selected courses to enroll student",
                    type: "for-each",
                    params: {
                        target: {
                            type: "jmespath",
